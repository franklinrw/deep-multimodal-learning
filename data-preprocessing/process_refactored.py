    ...
    for objectname in objectnames:
        for toolname in toolnames:
            for action in actions:
                ...
                # Append labels outside the sensor loop, but inside the action loop
                for set_name, data_set in data_sets.items():
        ...
        for set_name, data_set in data_sets.items():
            ...
            for sensor in sensornames:
                ...
                object_folder = os.path.join('C:/Users/Frank/OneDrive/Bureaublad/ARC/deep-multimodal-learning/data', objectname)
